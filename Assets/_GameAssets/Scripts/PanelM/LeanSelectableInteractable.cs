using TARGET = UnityEngine.UI.Selectable;
...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Selectable/Selectable.interactable" + LeanTransition.MethodsMenuSuffix + "(LeanSelectableInteractable)")]
	public class LeanSelectableInteractable : LeanMethodWithStateAndTarget
	{
...
namespace Lean.Transition
{
	public static partial class LeanExtensions
	{
		...
		{
			Method.LeanSelectableInteractable.Register(target, value, duration); return target;
		}
	}
}